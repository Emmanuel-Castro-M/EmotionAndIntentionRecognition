...
question = "In one word, choose between Greeting, Question, Answer, Statement Opinion, Statement Non Opinion, Apology, Command, Agreement, Disagreement, Acknowledge, Backchannel, and Others. Not a summary. What dialogical act is shown in the next text?: "

with open("IEMOCAP/RESULTS/Baseline_get_DA.csv", "w", newline='') as f:
